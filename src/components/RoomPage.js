...
// export const RoomPage = ({ accommodation, onBack }) => {
...
//           <p className="room-subtitle">{accommodation.address} • {accommodation.type} room</p>
//         </div>
//       </div>
...
//           {accommodation.image ? (
//             <img src={accommodation.image} alt={`${accommodation.name} room`} className="room-photo" />
//           ) : (
//             <div className="room-photo-placeholder">No photo available</div>
//           )}
//           <div className="room-details-content">
//             <h2>Room overview</h2>
//             <p>{accommodation.description || 'A comfortable room with essential amenities for student living.'}</p>
//             <ul className="room-facts">
//               <li><strong>Price:</strong> R{accommodation.price.toLocaleString()} / month</li>
//               <li><strong>Location:</strong> {accommodation.location}</li>
//               <li><strong>Type:</strong> {accommodation.type}</li>
//               <li><strong>Amenities:</strong> {accommodation.amenities.join(', ')}</li>
//             </ul>
//           </div>
//         </div>
...
//           <p>Rate your room and tell us how it feels.</p>
...
//               <p>Thank you! Your report was submitted.</p>
//             </div>
//           )}
//         </div>
//       </div>
...
// export const RoomPage = ({ accommodation, onBack, studentData }) => {
//   const [rating, setRating] = useState(0);
//   const [reportText, setReportText] = useState('');
//   const [submitted, setSubmitted] = useState(false);
...
//       author: studentData?.fullNames || 'Anonymous',
//       rating,
...
//               <h2 style={{ margin: 0, fontSize: '1.1rem', color: '#1f2937', fontWeight: 700 }}>
//                 Reviews
//               </h2>
...
//               <span>📧 support@biggyhousing.co.za</span>
//               <span>📞 +27 18 000 0000</span>
...
export const RoomPage = ({ accommodation, onBack, studentData, onApply }) => {
  const [rating, setRating] = useState(0);
  const [reportText, setReportText] = useState('');
  const [submitted, setSubmitted] = useState(false);
  const [hoveredStar, setHoveredStar] = useState(0);
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          <div style={{
            ...
            <span style={{ color: 'white', fontWeight: 800, fontSize: '1.1rem', letterSpacing: '1px' }}>🏠 BIGGY</span>
          </div>
          <h2 style={{ margin: 0, fontSize: '1.1rem', color: '#1f2937', fontWeight: 700 }}>Room Details</h2>
        </div>
        <button onClick={onBack} style={{
        ...
        <div style={{ flex: '1', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              ...
              {/* Photo 2 — secondary image (name1.jpg) */}
              {secondaryImage && (
                <img
                  src={secondaryImage}
