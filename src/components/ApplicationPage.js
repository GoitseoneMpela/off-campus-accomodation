...
export const ApplicationPage = ({ accommodation, studentData, onBack }) => {
  ...
  // SVG markup as a string for use inside the print window's HTML (colored, for the proof header logo)
  const logoSvgString = `
    <svg width="28" height="28" viewBox="0 0 88 100" role="img" style="display:inline-block;vertical-align:middle;margin-right:6px;">
      <defs>
        <linearGradient id="navBadgeGradPrint" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" style="stop-color:#764ba2" />
          <stop offset="100%" style="stop-color:#667eea" />
        </linearGradient>
      </defs>
      <rect x="4" y="2" width="80" height="96" rx="16" fill="url(#navBadgeGradPrint)" />
      <rect x="9" y="7" width="70" height="86" rx="12" fill="none" stroke="white" stroke-width="1.5" opacity="0.3" />
      <text x="44" y="68" font-family="Georgia, serif" font-size="62" font-weight="900" fill="white" text-anchor="middle" letter-spacing="-2">B</text>
      <circle cx="72" cy="86" r="5" fill="white" opacity="0.5" />
    </svg>
  `;

  // White/inverted version for use inside the colored stamp box
  const logoSvgStringWhite = `
    <svg width="24" height="24" viewBox="0 0 88 100" role="img" style="display:inline-block;vertical-align:middle;margin-right:6px;">
      <rect x="4" y="2" width="80" height="96" rx="16" fill="rgba(255,255,255,0.15)" stroke="white" stroke-width="2" />
      <text x="44" y="68" font-family="Georgia, serif" font-size="62" font-weight="900" fill="white" text-anchor="middle" letter-spacing="-2">B</text>
    </svg>
  `;
  ...
  const handlePrintProof = () => {
    ...
    const doc = `
      ...
      <body>
        ...
        <div class="header">
          <div>
            <div class="logo">${logoSvgString} BIGGY <span>HOUSING</span></div>
        ...
        <div class="section">
          ...
          <div class="row">
            <div class="field">
              <label>Faculty</label>
              <p>${'ECONOMIC MANAGEMENT SCIENCE'}</p>
            </div>
            <div class="field">
              <label>Course</label>
        ...
        <!-- Next of Kin Details -->
        <div class="section">
          <div class="section-title">Next of Kin Details Provided</div>
          <div class="row">
            <div class="field">
              <label>Next of Kin Name</label>
              <p>${formData.nextOfKinName || 'N/A'}</p>
            </div>
          </div>
          <div class="row">
            <div class="field">
        ...
        <div class="footer">
          ...
          <div class="stamp">
            <div class="stamp-logo-row">${logoSvgStringWhite} Biggy Housing</div>
              ...
              <>
                ...
                <div style={{
                  ...
                  <p style={{ margin: 0, color: '#d1d5db', fontSize: '0.82rem' }}>
                    Please provide details of a next of kin who can be contacted on your behalf.
                  </p>
                </div>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div style={{ marginBottom: '1rem' }}>
                    ...
                    <input
                      type="tel"
                      name="tel"
                      placeholder="Next of Kin's Cellphone Number"
                      required
                      value={formData.tel}
                      onChange={handleChange}
                      style={{
